...
echo "Please download the files from https://drive.google.com/drive/folders/15rLG87D1OdIScDUam1Ue9YgV2OgKxXHG?usp=sharing"
echo "And then put the csv files in this directory."
